...
public class HotelManagementController {
    ...
    public String getHotelWithMostFacilities(){
        ...
        int hotelWithMaxFacilities = 0 ;
        String hotelName ="" ;
        for (Hotel hotel: hotelMap.values() ){
            if(hotel.getFacilities().size()>hotelWithMaxFacilities){
                hotelWithMaxFacilities = hotel.getFacilities().size() ;
                hotelName = hotel.getHotelName() ;
            } else if (hotel.getFacilities().size()== hotelWithMaxFacilities) {
